...
import net.sppan.base.service.impl.ResourceServiceImpl;
...
public class MyRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(
		...
		List<Role> roles = roleService.findRoleListByUserId(dbUser.getId());
		if(roles != null){
			for (Role role : roles) {
				List<Resource> resources = resourceServiceImpl.findMenuByRoleId(role.getId());
				if(resources != null){
